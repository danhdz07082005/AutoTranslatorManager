...
(function() {
    const dict = {
        'vi': {
            ...
            'card.delete_disabled_translating': 'Không thể xóa khi game đang dịch hoặc đang chạy',
            ...
            'glossary.btn_select': 'Chọn',
            'glossary.btn_select_all': 'Chọn tất cả',
            'glossary.btn_deselect_all': 'Bỏ chọn tất cả',
            'glossary.btn_delete_selected': 'Xóa ({count})',
            'glossary.btn_cancel_select': 'Hủy',
            'glossary.delete_multiple_confirm': 'Bạn có chắc chắn muốn xóa {count} thuật ngữ đã chọn?',
            'glossary.delete_multiple_success': 'Đã xóa thành công {count} thuật ngữ.',
            'glossary.no_term_selected': 'Chưa chọn thuật ngữ nào!',
            'glossary.empty': 'Chưa có thuật ngữ nào',
        ...
        'en': {
            ...
            'glossary.btn_select': 'Select',
            'glossary.btn_select_all': 'Select All',
            'glossary.btn_deselect_all': 'Deselect All',
            'glossary.btn_delete_selected': 'Delete ({count})',
            'glossary.btn_cancel_select': 'Cancel',
            'glossary.delete_multiple_confirm': 'Are you sure you want to delete {count} selected terms?',
            'glossary.delete_multiple_success': 'Successfully deleted {count} terms.',
            'glossary.no_term_selected': 'No terms selected!',
            'glossary.empty': 'No terms added yet',
            ...
            'card.delete_disabled_translating': 'Cannot delete game while translating or running',
